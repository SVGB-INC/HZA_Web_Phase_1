<%@ Page Language="C#" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="searchFilter.aspx.cs" Inherits="HZA_Web_Phase_1.searchFilter" EnableEventValidation="False" Async="True" %>
                                ...
                                <div class="card-body p-3 p-sm-1">
                                    <div class="row d-block d-xl-flex align-items-center">
                                        <div class="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">
                                            ...
                                            <div class="d-sm-none">
                                                <h2 class="fw-extrabold h5">Filtered Companies</h2>
                                                <h3 class="mb-1">50.88%</h3>
                                            </div>
                                        </div>
                                        <div class="col-12 col-xl-7 px-xl-0">
                                            <div class="d-none d-sm-block">
                                                <h2 class="h6 text-gray-400 mb-0">Filtered Companies</h2>
                                                <h3 class="fw-extrabold mb-2">
                                                    <asp:Label ID="dataCompanies" runat="server" Text="0000"></asp:Label></h3>
                                            </div>
            ...
            <div class="row">
                <div class="col-12 mb-4">
                    ...
                    <div class="form-group row gap-2 py-3">
                        <label for="sic-code" class="col-sm-2 col-form-label text-white">Search Now</label>
                        <div class="col-sm-2">
